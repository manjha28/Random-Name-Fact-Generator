...
ImageDraw.Draw(image).text((1000-400,1000-30),'Made with Love By @man_jha',fill='rgb(0,0,0)',font=watermark_font)

'''Showing Output'''
dir_path =  r"C:\Users\manis\Downloads\.png"

Format = ("%s" % (name)) + ".png"
file_path = os.path.join( dir_path, Format)
